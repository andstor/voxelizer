import { TorusKnotGeometry, MeshBasicMaterial, Mesh, CanvasTexture } from 'three';

/**
 * Generate a basic three.js mesh.
 */
export function getSimpleMesh() {
  let geometry = new TorusKnotGeometry( 10, 3, 16, 100 );
 ...
 * @param {string} color The color to fill the image with.
 */
